(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("prop-types"), require("react"), require("react-dom"), require("react-dom/server"));
	else if(typeof define === 'function' && define.amd)
		define(["prop-types", "react", "react-dom", "react-dom/server"], factory);
	else if(typeof exports === 'object')
		exports["ReactQuill"] = factory(require("prop-types"), require("react"), require("react-dom"), require("react-dom/server"));
	else
		root["ReactQuill"] = factory(root["PropTypes"], root["React"], root["ReactDOM"], root["ReactDOMServer"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_prop_types__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_dom__, __WEBPACK_EXTERNAL_MODULE_react_dom_server__) {
...
(function(f) {
  if (true) {
    module.exports = f(__webpack_require__(/*! react */ "react"));
    /* global define */
  } else { var g; }
})(function(React) {
  /**
...
/* harmony import */ var _mixin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mixin */ "./src/mixin.js");
...
/* harmony import */ var react_dom_factories__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-dom-factories */ "./node_modules/react-dom-factories/index.js");
...
var QuillComponent = create_react_class__WEBPACK_IMPORTED_MODULE_2___default()({
	...
	propTypes: {
		...
		value: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.shape({ops: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.array})]),
		defaultValue: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.shape({ops: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.array})]),
		...
		bounds: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.element]),
		onChange: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.func,
		onChangeSelection: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.func,
		...
		onKeyPress: prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.func,
		...
		modules: function(props) {
			var isNotObject = prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.object.apply(this, arguments);
		...
		formats: function(props) {
			var isNotArrayOfString = prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.string).apply(this, arguments);
		...
		children: function(props) {
			...
			var isNotASingleElement = prop_types__WEBPACK_IMPORTED_MODULE_7___default.a.element.apply(this, arguments);
			...
			if (react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.count(props.children)) {
				var child = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.only(props.children);
	...
	*/
	renderEditingArea: function() {
		...
		var customElement = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.count(children)
			? react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.only(children)
			: null;

		var editingArea = customElement
			? react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(customElement, properties)
			: react_dom_factories__WEBPACK_IMPORTED_MODULE_8___default.a.div(properties);
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: Mixin, Toolbar, Quill, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var quill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! quill */ "./node_modules/quill/dist/quill.js");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Mixin", function() { return _mixin__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _toolbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./toolbar */ "./src/toolbar.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Toolbar", function() { return _toolbar__WEBPACK_IMPORTED_MODULE_3__["default"]; });
...
module.exports = _component__WEBPACK_IMPORTED_MODULE_1__["default"];
module.exports.Mixin = _mixin__WEBPACK_IMPORTED_MODULE_2__["default"];
module.exports.Toolbar = _toolbar__WEBPACK_IMPORTED_MODULE_3__["default"];
module.exports.Quill = quill__WEBPACK_IMPORTED_MODULE_0___default.a;
...
var QuillMixin = {
	...
	*/
	createEditor: function($el, config) {
		var editor = new quill__WEBPACK_IMPORTED_MODULE_0___default.a($el, config);
...
/* harmony import */ var react_dom_factories__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-dom-factories */ "./node_modules/react-dom-factories/index.js");
/* harmony import */ var react_dom_factories__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_dom_factories__WEBPACK_IMPORTED_MODULE_6__);
/*
...
var QuillToolbar = create_react_class__WEBPACK_IMPORTED_MODULE_2___default()({
	...
	propTypes: {
		...
		items:     prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.array
	},
	...
	shouldComponentUpdate: function(nextProps, nextState) {
		return !lodash_isEqual__WEBPACK_IMPORTED_MODULE_4___default()(nextProps, this.props);
	},

	renderGroup: function(item, key) {
		return react_dom_factories__WEBPACK_IMPORTED_MODULE_6___default.a.span({
			key: item.label || key,
	...
	renderChoiceItem: function(item, key) {
		return react_dom_factories__WEBPACK_IMPORTED_MODULE_6___default.a.option({
	...
	renderChoices: function(item, key) {
		...
		var selectedItem = lodash_find__WEBPACK_IMPORTED_MODULE_3___default()(item.items, function(item){ return item.selected });
		var attrs = {
			key: item.label || key,
			title: item.label,
		...
		return react_dom_factories__WEBPACK_IMPORTED_MODULE_6___default.a.select(attrs, choiceItems);
	},

	renderButton: function(item, key) {
		return react_dom_factories__WEBPACK_IMPORTED_MODULE_6___default.a.button({
			type: 'button',
			key: item.label || item.value || key,
			value: item.value,
			className: 'ql-'+item.type,
	...
	render: function() {
		...
		var html = children.map(react_dom_server__WEBPACK_IMPORTED_MODULE_1___default.a.renderToStaticMarkup).join('');
		return react_dom_factories__WEBPACK_IMPORTED_MODULE_6___default.a.div({
			id: this.props.id,
...
/* harmony default export */ __webpack_exports__["default"] = (QuillToolbar);
